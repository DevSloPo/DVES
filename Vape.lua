...
function lib:Window(text, preset, closebind)
    ...
    windowBackground.Parent = Main
    windowBackground.Size = UDim2.new(1, 0, 1, 0)  
    windowBackground.Image = "rbxassetid://130334722921348"  
...
OkayBtnTitle.BackgroundTransparency = 0.7
...
OkayBtnTitle.TextXAlignment = Enum.TextXAlignment.Left
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Button(text, callback)
            ...
            Button.Size = UDim2.new(0, 363, 0, 32) 
            ...
            ButtonTitle.Size = UDim2.new(0, 187, 0, 32)
        ...
        function tabcontent:Toggle(text,default, callback)
            ...
            Toggle.Size = UDim2.new(0, 363, 0, 32) 
            ...
            ToggleTitle.Size = UDim2.new(0, 187, 0, 32)
            ...
            FrameToggle1.Position = UDim2.new(0.859504104, 0, 0.25, 0)
    ...
    Slider.Size = UDim2.new(0, 363, 0, 45)
    ...
    SliderTitle.Size = UDim2.new(0, 187, 0, 32)
    ...
    SliderValue.Size = UDim2.new(0, 335, 0, 32)
    SliderValue.Font = Enum.Font.Gotham
    local initialValue = start or min
    ...
    CurrentValueFrame.Size = UDim2.new((initialValue - min) / (max - min), 0, 0, 3)

    SlideCircle.Name = "SlideCircle"
    SlideCircle.Parent = SlideFrame
    SlideCircle.BackgroundColor3 = PresetColor
    SlideCircle.BackgroundTransparency = 1.000
    SlideCircle.Position = UDim2.new((initialValue - min) / (max - min), -6, -1.30499995, 0)
    ...
    local function move()
        ...
        local relativeX = math.clamp((mouseX - SlideFrame.AbsolutePosition.X) / SlideFrame.AbsoluteSize.X, 0, 1)

        local pos = UDim2.new(relativeX, -6, -1.30499995, 0)
        local pos1 = UDim2.new(relativeX, 0, 0, 3)
    ...
    Tab.CanvasSize = UDim2.new(0, 0, 0, TabLayout.AbsoluteContentSize.Y)
        ...
        function tabcontent:Dropdown(text, list, callback)
            ...
            DropdownTitle.Size = UDim2.new(0, 187, 0, 32)
        ...
        function tabcontent:Colorpicker(text, preset, callback)
            ...
            Colorpicker.Size = UDim2.new(0, 363, 0, 32)
            ...
            ColorpickerTitle.Size = UDim2.new(0, 187, 0, 32)
        ...
        function tabcontent:Label(text)
            ...
            Label.Size = UDim2.new(0, 363, 0, 32)
            ...
            LabelTitle.Size = UDim2.new(0, 187, 0, 32)
        ...
        function tabcontent:Textbox(text, disapper, callback)
            ...
            TextboxTitle.Size = UDim2.new(0, 187, 0, 32)
        ...
        function tabcontent:Bind(text, keypreset, callback)
            ...
            Bind.Size = UDim2.new(0, 363, 0, 32)
            ...
            BindText.Size = UDim2.new(0, 337, 0, 32)
